...
3. **환자용 모바일 앱 (APK) 다운로드 링크**:
   * **URL**: [http://qrdoc.devbeaver.cloud/qrdoc.apk?v=11](http://qrdoc.devbeaver.cloud/qrdoc.apk?v=11)
   * *(※ Cloudflare CDN 캐시 우회를 위해 주소 뒤에 `?v=11` 캐시 버스터 파라미터를 추가하여 접속해 주시기 바랍니다.)*
4. **백엔드 직접 API 엔드포인트**:
